 ...
 *      address --^^-^^ ^^-^^-^^-^^-- values
 *
 * You can only read 4 bytes at a time.
 */
 ...
 *       value ---------^^-^^
 *
 * The value increases as the sample gets darker, so we can guess this
 * function is counting a number of pulses.
 */
 ...
 *      value ----^^-^^-^^-^^
 *
 * The value increases as the sample gets lighter, so we can guess this
 * function is counting pulses for a set amount of time.
 */
